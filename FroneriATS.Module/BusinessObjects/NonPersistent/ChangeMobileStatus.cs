...
namespace FroneriEG.Module.BusinessObjects.NonPersistent
{
    ...
    [XafDisplayName("Change Mobile Status")]
    //[DevExpress.ExpressApp.SystemModule.ListViewAutoFilterRow(true)]
    [ListViewFindPanel(true)]
    public class ChangeMobileStatus : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        ...
        private mobile_status fstatus_id;
