...
namespace FroneriATS.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class FroneriATSAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private FroneriATS.Module.FroneriATSModule module3;
        private FroneriATS.Module.Web.FroneriATSAspNetModule module4;
        ...
        static FroneriATSAspNetApplication() {
        ...
        #endregion
        public FroneriATSAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void FroneriATSAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new FroneriATS.Module.FroneriATSModule();
            this.module4 = new FroneriATS.Module.Web.FroneriATSAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.FroneriATSAspNetApplication_DatabaseVersionMismatch);
